...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/BSDiff/BSDiff.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNZipArchive/RNZipArchive.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-pager-view/react_native_pager_view.framework"
